...
```json
{
  "repositories": [
    {
      "type": "vcs",
      "url": "https://github.com/unione-repo/php7-sdk.git"
    }
  ],
  "require": {
    "unione-repo/php7-sdk": "*@dev"
  }
}
```
...
```php
<?php
require_once('/path/to/php7-sdk/vendor/autoload.php');
```
...
*SystemApi* | [**systemPing**](docs/Api/SystemApi.md#systemping) | **POST** /system/ping.json | Checks API key validity and returns user ID.
...
- [SystemPing200Response](docs/Model/SystemPing200Response.md)
